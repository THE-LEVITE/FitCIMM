...
<html>
    <head>
        ...
        <title>Lista de Planes - FitCIMM</title>
        ...
        <style>
            ...
            .card-custom .card-header i { color: #4a6fa5; margin-right: 8px; }
            ...
            .table-container .table tbody tr:hover { background: #f8fafc; }
            ...
            .btn-actions .btn { padding: 4px 8px; font-size: 13px; border-radius: 4px; line-height: 1; }
            .btn-actions .btn i { font-size: 14px; }
            
            .btn-actions .btn-outline-primary { color: #4a6fa5; border-color: #dce3ec; }
            .btn-actions .btn-outline-primary:hover { background: #ebf4ff; border-color: #4a6fa5; }
            
            .btn-actions .btn-outline-danger { color: #dc2626; border-color: #dce3ec; }
            .btn-actions .btn-outline-danger:hover { background: #fef2f2; border-color: #dc2626; }
            ...
            .empty-state { padding: 40px 20px; text-align: center; color: #8a9bb5; }
            .empty-state i { font-size: 48px; display: block; margin-bottom: 12px; color: #dce3ec; }
            .empty-state h5 { color: #4a5568; margin-bottom: 4px; }
            ...
            @media (max-width: 768px) {
                ...
                .toolbar .search-box { min-width: auto; }
                .table-container .table { font-size: 12px; }
                .table-container .table thead th,
                .table-container .table tbody td { padding: 8px 10px; }
                .page-title { font-size: 20px; }
                .btn-actions .btn { padding: 3px 6px; font-size: 11px; }
                .btn-actions .btn i { font-size: 12px; }
            }
        </style>
    </head>
    <body>
        ...
        <div class="main-content">
            ...
            <div class="page-header-custom">
                <h1 class="page-title"><i class="bi bi-card-list"></i> Lista de Planes</h1>
                <div class="page-subtitle">Gestión de planes de membresía</div>
            </div>
            ...
            <div class="card-custom">
                <div class="card-header">
                    <i class="bi bi-list"></i> Planes Registrados
                    <span class="badge-count">${listPlan.size()} planes</span>
                </div>
                <div class="card-body p-0">
                    <div class="table-container">
                        <table class="table">
                            ...
                            <tbody>
                                <c:forEach var="Plan" items="${listPlan}" varStatus="status">
                                    <tr>
                                ...
                                <c:if test="${empty listPlan}">
                                    <tr>
                                        <td colspan="5" class="empty-state">
                                            ...
                                            <p class="text-muted" style="font-size: 13px;">Crea un nuevo plan usando el botón "Nuevo Plan"</p>
                                        </td>
                                    </tr>
                                </c:if>
                            </tbody>
