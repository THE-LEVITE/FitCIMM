...
<html>
    <head>
        ...
        <title>Lista de Socios - FitCIMM</title>
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="page-header-custom">
                <h1 class="page-title"><i class="bi bi-people"></i> Lista de Socios</h1>
                <div class="page-subtitle">Gestión de socios registrados en el gimnasio</div>
            </div>
            ...
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        <c:forEach var="socio" items="${listSocios}">
                            <tr>
                                <td>
                                    ...
                                    <td style="text-align: center;">
                                        <div class="btn-actions">
                                            <form action="SocioControlador" method="POST" style="display: inline;">
                                                ...
                                                <button type="submit" name="Editar" value="editar" class="btn btn-outline-primary btn-sm" title="Editar">
                                                    <i class="bi bi-pencil"></i>
                                                </button>
                                                <button type="submit" name="Eliminar" value="eliminar" class="btn btn-outline-danger btn-sm"
                                                        onclick="return confirm('¿Está seguro de inactivar este socio?');" title="Inactivar">
                            ...
                            <c:if test="${empty listSocios}">
                                <tr>
                                    <td colspan="8" class="text-center py-4 text-muted">
                                        <i class="bi bi-info-circle" style="font-size: 20px; display: block; margin-bottom: 6px;"></i>
                ...
                <div class="mt-3 text-muted" style="font-size: 13px;">
                    ...
                    <strong>${listSocios.size()}</strong> socios registrados
